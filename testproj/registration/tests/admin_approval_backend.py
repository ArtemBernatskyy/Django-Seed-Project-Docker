...
from testproj.registration.models import SupervisedRegistrationProfile
from testproj.registration.backends.admin_approval.views import RegistrationView
