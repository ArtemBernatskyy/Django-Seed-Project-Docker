...
from testproj.registration.forms import RegistrationForm
from testproj.registration.backends.default.views import RegistrationView
from testproj.registration.models import RegistrationProfile
from testproj.registration.users import UserModel
